...
export function MarkPaidForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      />
      <p className="-mt-2 text-xs text-ink-muted">Prefilled with the expected amount — adjust if this month's bill differs.</p>

      {accounts.length > 0 ? (
        <div className="flex flex-col gap-1.5">
          <label htmlFor="paid-from-account" className="text-sm font-medium text-ink">
